...
exports.wrapperAbi = exports.vaultAbi = void 0;
exports.vaultAbi = [
    {
        inputs: [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'bool', name: 'allowToken0', type: 'bool' },
            { indexed: false, internalType: 'bool', name: 'allowToken1', type: 'bool' },
            { indexed: false, internalType: 'address', name: 'owner', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'twapPeriod', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, internalType: 'address', name: 'sender', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'deposit0Max', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'deposit1Max', type: 'uint256' },
        ],
        name: 'DepositMax',
        type: 'event',
    },
    {
        ...
        inputs: [
            { indexed: true, internalType: 'address', name: 'sender', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'hysteresis', type: 'uint256' },
        ],
        name: 'Hysteresis',
        type: 'event',
    },
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint32', name: 'newTwapPeriod', type: 'uint32' },
        ],
        name: 'SetTwapPeriod',
        type: 'event',
    },
    ...
    {
        inputs: [{ internalType: 'uint32', name: 'newTwapPeriod', type: 'uint32' }],
        name: 'setTwapPeriod',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
